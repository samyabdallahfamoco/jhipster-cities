...
import { CityJhpCitiesComponent } from 'app/entities/city-jhp-cities/city-jhp-cities.component';
...
describe('Component Tests', () => {
  describe('CityJhpCities Management Component', () => {
    let comp: CityJhpCitiesComponent;
    let fixture: ComponentFixture<CityJhpCitiesComponent>;
    let service: CityJhpCitiesService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterCitiesTestModule],
        declarations: [CityJhpCitiesComponent],
        providers: [
          {
        ...
        .overrideTemplate(CityJhpCitiesComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CityJhpCitiesComponent);

...
import { ManagerJhpCitiesComponent } from 'app/entities/manager-jhp-cities/manager-jhp-cities.component';
...
describe('Component Tests', () => {
  describe('ManagerJhpCities Management Component', () => {
    let comp: ManagerJhpCitiesComponent;
    let fixture: ComponentFixture<ManagerJhpCitiesComponent>;
    let service: ManagerJhpCitiesService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterCitiesTestModule],
        declarations: [ManagerJhpCitiesComponent],
        providers: [
          {
        ...
        .overrideTemplate(ManagerJhpCitiesComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ManagerJhpCitiesComponent);

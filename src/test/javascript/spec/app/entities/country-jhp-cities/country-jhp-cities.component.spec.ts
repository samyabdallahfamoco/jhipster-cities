...
import { CountryJhpCitiesComponent } from 'app/entities/country-jhp-cities/country-jhp-cities.component';
...
describe('Component Tests', () => {
  describe('CountryJhpCities Management Component', () => {
    let comp: CountryJhpCitiesComponent;
    let fixture: ComponentFixture<CountryJhpCitiesComponent>;
    let service: CountryJhpCitiesService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterCitiesTestModule],
        declarations: [CountryJhpCitiesComponent],
        providers: [
          {
        ...
        .overrideTemplate(CountryJhpCitiesComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CountryJhpCitiesComponent);

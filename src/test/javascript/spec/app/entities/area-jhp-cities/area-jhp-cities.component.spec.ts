...
import { AreaJhpCitiesComponent } from 'app/entities/area-jhp-cities/area-jhp-cities.component';
...
describe('Component Tests', () => {
  describe('AreaJhpCities Management Component', () => {
    let comp: AreaJhpCitiesComponent;
    let fixture: ComponentFixture<AreaJhpCitiesComponent>;
    let service: AreaJhpCitiesService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterCitiesTestModule],
        declarations: [AreaJhpCitiesComponent],
        providers: [
          {
        ...
        .overrideTemplate(AreaJhpCitiesComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AreaJhpCitiesComponent);

...
public class CityResourceIT {
    ...
    private static final Double DEFAULT_NB_PEOPLE = 1D;
    private static final Double UPDATED_NB_PEOPLE = 2D;
    ...
    @Test
    @Transactional
    public void checkNbPeopleIsRequired() throws Exception {
        int databaseSizeBeforeTest = cityRepository.findAll().size();
        // set the field null
        city.setNbPeople(null);
